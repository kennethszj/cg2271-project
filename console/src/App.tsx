...
import { ChakraProvider, Tabs, TabList, TabPanels, Tab, TabPanel, Button, Box, VStack, Heading, Icon } from '@chakra-ui/react';
import { FaStopCircle, FaLongArrowAltUp, FaLongArrowAltDown } from 'react-icons/fa';
      ...
      <Box p={4} maxWidth='600px' mx='auto'>
        ...
        <Tabs variant='enclosed'>
          <Box overflowX='auto' overflowY='hidden'>
            ...
            <TabList>
              <Tab whiteSpace='nowrap' _selected={{ color: 'white', bg: 'teal.500' }} fontWeight='bold'>
                Default
              </Tab>
              <Tab whiteSpace='nowrap' _selected={{ color: 'white', bg: 'teal.500' }} fontWeight='bold'>
                Terminal
