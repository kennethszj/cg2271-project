...
void moveForward() {
    setMotorSpeed(0, 100, 0);
    setMotorSpeed(1, 100, 0);
    setMotorSpeed(2, 100, 0);
    setMotorSpeed(3, 100, 0);
}
void moveBackward(){
    setMotorSpeed(0, 0, 100);
    setMotorSpeed(1, 0, 100);
    setMotorSpeed(2, 0, 100);
    setMotorSpeed(3, 0, 100);
}

void moveCW() {
    setMotorSpeed(0, 0, 100);  // Motor 0 (Right Front) Reverse
    setMotorSpeed(1, 0, 100);  // Motor 1 (Right Back) Reverse
    setMotorSpeed(2, 100, 0);  // Motor 2 (Left Front) Forward
    setMotorSpeed(3, 100, 0);  // Motor 3 (Left Back) Forward
}
